      ...
      <Form className="w-full relative rounded-xl bg-darkslategray-200 flex flex-col pb-3 pl-[10px] top-5 items-center justify-start gap-[25px] z-[1]">
        ...
        <div className="w-full self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[5px]">
          <div className="flex-1 rounded-mini bg-gray-100 flex flex-row items-center justify-start py-4 px-2 gap-[21px] z-[2]">
            <div className="h-14 w-[100%] relative rounded-mini bg-gray-100 hidden" />
            <img
        ...
        {logged && <div className="self-stretch flex flex-col items-center justify-start gap-[10px] max-w-full mq450:gap-[10px]">
          <div className="self-stretch rounded-mini bg-gray-100 flex flex-row items-start justify-start pt-3.5 px-2.5 pb-2.5 box-border gap-[10px] max-w-full z-[1]">
            ...
            />
            <input
              className="w-full [border:none] [outline:none] bg-[transparent] h-5 flex flex-col items-start justify-start pt-[3px] px-0 pb-[0.10000000000000142px] box-border font-roboto text-base text-gray-200"
