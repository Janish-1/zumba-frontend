...
const ForgetPassword1 = () => {
  return (
    <div className="w-full relative bg-gray-200 overflow-hidden flex flex-col items-center justify-start pt-20 pb-[92px] pr-[13px] pl-3 box-border gap-[38px] tracking-[normal]">
      ...
      <section className="self-stretch flex flex-row items-start justify-start relative max-w-full">
        <div className="h-[673.9px] w-[403.1px] absolute my-0 mx-[!important] top-[-255px] left-[0px] flex items-center justify-center z-[0]">
          <img
