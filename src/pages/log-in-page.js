...
const LogInPage = () => {
  return (
    ...
    <div className="w-full h-full relative  bg-gray-200 overflow-hidden flex flex-col items-center justify-end pt-[311px] pb-[77px] pr-[13px] pl-3 box-border text-justify text-23xl text-firebrick font-arvo">
      <div className="w-[403px] h-[674px] my-0 mx-[!important] absolute top-[129px] left-[12px] flex flex-row items-start justify-start py-[58px] px-2 box-border">
        ...
        <h1 className="m-0 h-[104px] w-[100%] relative text-inherit font-bold font-inherit flex items-end shrink-0 z-[1]">
          Be,<br/>
          Yourself
        </h1>
      </div>
